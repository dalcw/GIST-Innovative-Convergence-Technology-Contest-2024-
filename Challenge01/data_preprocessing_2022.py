...
# 파일명
file_list = os.listdir("../../2022/전력일보/")
file_list.sort()
...
for i in range(1, 63):
    ...
    # file read
    df1 = pd.read_excel("../../2022/전력일보/" + file_list[i]).iloc[9:, extraction_idx_1].astype(float)
    df2 = pd.read_excel("../../2022/전력일보/" + file_list[i+62]).iloc[9:, extraction_idx_2].astype(float)
...
dates = pd.date_range(start="2022-07-01", end="2022-08-31")
